...
train_data= np.load('/Users/siddharth/Documents/Brainconnectivity/data_EEGMASTER/training_set.npy').astype('float32')
train_labels= np.load('/Users/siddharth/Documents/Brainconnectivity/data_EEGMASTER/training_label.npy').astype('float32')

test_data= np.load('/Users/siddharth/Documents/Brainconnectivity/data_EEGMASTER/test_set.npy').astype('float32')
test_labels= np.load('/Users/siddharth/Documents/Brainconnectivity/data_EEGMASTER/test_label.npy').astype('float32')
...
#%%
DIR='/Users/siddharth/Documents/Brainconnectivity/data_EEGMASTER/'
Adjacency_Matrix = np.load('/Users/siddharth/Documents/Brainconnectivity/data_EEGMASTER/Adjacency_Matrix.npy').astype('float32')
